...
const oldHtml = cp.execSync('git show HEAD:dist/harga/bore-pile-2026.html', {encoding: 'utf8'});
const newHtml = fs.readFileSync('dist/harga/bore-pile-2026.html', 'utf8');
